-- ============================================================
-- Air Cargo Analysis
-- Full project script, tasks 2 to 20 in a single file
--
-- Task 1 is the entity relationship diagram itself, and has no
-- SQL attached to it, so this script begins at task 2.
--
-- Every query for this project is written here, one after another,
-- clearly labelled by task number and separated by comment headers.
-- The result of each task, run against the real dataset, sits in
-- its own file in the Results folder.
-- ============================================================
...
-- ------------------------------------------------------------
-- Task 2: Create the route_details table with constraints
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- Task 3: Passengers who travelled on routes 1 to 25
-- ------------------------------------------------------------
SELECT *
...
-- ------------------------------------------------------------
-- Task 4: Business class passenger count and revenue
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- Task 5: Customer full name
-- ------------------------------------------------------------
SELECT customer_id, CONCAT(first_name, ' ', last_name) AS FULL_NAME
FROM customer;

-- ------------------------------------------------------------
-- Task 6: Customers who have registered and booked a ticket
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- Task 7: Customer name by brand, Emirates
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- Task 8: Economy Plus passengers using GROUP BY and HAVING
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- Task 9: Whether revenue has crossed 10000
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- Task 10: Create and grant access to a new user
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- Task 11: Max ticket price per class using a window function
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- Task 12: Passengers on route 4, with an index added for speed
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- Task 13: Execution plan for route 4, before and after the index
-- ------------------------------------------------------------
EXPLAIN SELECT * FROM passengers_on_flights
WHERE route_id = 4;

-- ------------------------------------------------------------
-- Task 14: Total price per customer and aircraft using ROLLUP
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- Task 15: A view of business class customers and their brand
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- Task 16: Stored procedure, passengers within a route range
-- ------------------------------------------------------------
DELIMITER $$
...
-- ------------------------------------------------------------
-- Task 17: Stored procedure, routes over 2000 miles
-- ------------------------------------------------------------
DELIMITER $$
...
-- ------------------------------------------------------------
-- Task 18: Stored procedure, distance category SDT IDT LDT
-- ------------------------------------------------------------
DELIMITER $$
...
-- ------------------------------------------------------------
-- Task 19: Stored function inside a stored procedure, complimentary services
-- ------------------------------------------------------------
DELIMITER $$
...
-- ------------------------------------------------------------
-- Task 20: Cursor, first customer whose last name ends with Scott
-- ------------------------------------------------------------
DELIMITER $$
